...
export default class SpaceCraftScreen extends Component {
    ...
    renderItem = ({iteam}) => {
        return(
            <View style = {{borderWidth:1, justifyContent:'center', alignItems: 'center', marginBottom:10, elevation:10}}></View>
            <Image
            source={{uri: iteam.agency.image_url}} style = {{borderWidth:1, justifyContent: 'center, align items:'center,marginTop: 15, marginBottom:115, marginRight:10}}></Image>
